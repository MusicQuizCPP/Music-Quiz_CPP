...
YoutubeDownloader::YoutubeDownloader(std::string url, std::vector<std::string> preferedFormats) :
_url(url), _preferedFormats(preferedFormats)
{
...
size_t YoutubeDownloader::getDownloadedBytes()
{
